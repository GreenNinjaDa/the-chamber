...
- **Level 6 — Red Light, Green Light** (`src/levels/redLight/`): a 7 m doll (`entities/doll.ts`) stands by the east
  ...
  red lights; stopping from a sprint takes ~0.42 s) while she has a clear ray from her eyes to your head, chest or
  pelvis gets you lasered (two red beams) and flung, violence 22. Moving behind something tall (fridge, vending
  machine, bookcase; low things don't hide you from 6 m up) is safe. You arrive at (-9.5, 0) facing east; cross the
